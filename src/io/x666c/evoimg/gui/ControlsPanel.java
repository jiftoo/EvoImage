...
public class ControlsPanel extends JPanel {
	...
	public ControlsPanel(InfoPane p, EvoGui gui) {
		...
		((DefaultFormatter)((JSpinner.NumberEditor) vertexAmount.getEditor()).getTextField().getFormatter()).setCommitsOnValidEdit(true);
	...
	public void setImageForPreview(BufferedImage img) {
		...
		BufferedImage resize = new BufferedImage(imagePreview.getWidth(), imagePreview.getHeight(), BufferedImage.TYPE_INT_RGB);
		...
		DisplayCanvas.DISPLAY_WIDTH = tw;
		DisplayCanvas.DISPLAY_HEIGHT = th;
		gui.packCanvas();
	}
